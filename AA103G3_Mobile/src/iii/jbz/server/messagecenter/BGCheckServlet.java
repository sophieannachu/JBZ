...
import iii.jbz.server.messagecenter.BGCheckVO;
...
//		String action = req.getParameter("action");
		...
		if (action.equals("getAll")) {
			...
			List<BGCheckVO> bgCheckVOs = bgcheckDao.getAll(memno);
...
//				
//				BGCheckVO groupInfoVO = groupInfoSv.getOneGroupInfo(group_no);
//								
...
//					in.close();
//				}
//				BGCheckVO groupInfoVO = groupInfoSv.updateGroupInfoPhoto(group_no,groupCheck,group_memno,group_name,group_loc,group_detial,groupCount,photo);
//
//								
//				/***************************3.查詢完成,準備轉交(Send the Success view)************/
//				req.setAttribute("groupInfoVO", groupInfoVO);         // 資料庫取出的empVO物件,存入req
...
//			
//			BGCheckVO groupInfoVO = new BGCheckVO();
//			
