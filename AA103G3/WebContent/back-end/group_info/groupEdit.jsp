		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<div style="border:solid 1px;">
					<form action="<%=request.getContextPath()%>/group_info/GroupinfoServlet.do"
						...
						團主編號: <input type="text" name="groupMemno" value="${groupInfoVO.memno}"><br>
						 ...
						 開團細節: <input type="text" name="group_detial" value="${groupInfoVO.group_detail}"><br> 
						 揪團圖片: <input type="file" name="fname"><br> 
		    					...
		    					<input type="hidden" name="group_long" value="${groupInfoVO.group_long}"> 
						 		<input type="hidden" name="group_lati" value="${groupInfoVO.group_lati}">
