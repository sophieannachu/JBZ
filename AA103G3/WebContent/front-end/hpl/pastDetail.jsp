		...
		<div class="well outter_hpl col-sm-12" style="">
			...
			<div class="col-sm-8" style="padding: 0 0;">
				...
				<div class="record_detail" style="">
					<dl>
			          <dt class="record_font_detail" style=""><i class="fa fa-circle" style="color:#4b76b5;margin-right:5px;font-size:20px;"></i>結束體重為 ${hplMap['now_weight']} 公斤</dt>
	...
	<c:if test="${hplVO.hpwaist != -1 && hplVO.hpwaist != 0}">
		<div class="well outter_hpl col-sm-12" style="">
			...
			<div class="col-sm-8" style="padding: 0 0;">
				...
				<div class="record_detail" style="">
					<dl>
			          <dt class="record_font_detail" style=""><i class="fa fa-circle" style="color:#4b76b5;margin-right:5px;font-size:20px;"></i>結束腰圍為 ${hplMap['now_waist']} 公分</dt>
<!-- 			          <dt class="record_font_detail" style=""><i class="fa fa-circle" style="color:#4b76b5;margin-right:5px;"></i>123456</dt> -->
			        </dl>
		        </div>
			</div>
	...
	<c:if test="${hplVO.hpbp != -1 && hplVO.hpbp != 0}">
		<div class="well outter_hpl col-sm-12" style="">
			<div class="col-sm-8" style="padding: 0 0;">
				...
				<div class="record_detail" style="">
					<dl>
			          <dt class="record_font_detail" style=""><i class="fa fa-circle" style="color:#4b76b5;margin-right:5px;font-size:20px;"></i>累計紀錄筆數共 ${hplMap['hpbp_Endtimes']} 次</dt>
			          <dt class="record_font_detail" style=""><i class="fa fa-circle" style="color:#4b76b5;margin-right:5px;font-size:20px;"></i>目標達成數共 ${hplMap['hpbp_goalTimes']} 次</dt>
			        </dl>
		        </div>
	        </div>
	...
	<c:if test="${hplVO.hpbg != -1 && hplVO.hpbg != 0}">
		<div class="well outter_hpl col-sm-12" style="">
			<div class="col-sm-8" style="padding: 0 0;">
				...
				<div class="record_detail" style="">
					<dl>
			          <dt class="record_font_detail" style=""><i class="fa fa-circle" style="color:#4b76b5;margin-right:5px;font-size:20px;"></i>累計紀錄筆數共 ${hplMap['hpbg_Endtimes']} 次</dt>
			          <dt class="record_font_detail" style=""><i class="fa fa-circle" style="color:#4b76b5;margin-right:5px;font-size:20px;"></i>目標達成數共 ${hplMap['hpbg_goalTimes']} 次</dt>
			        </dl>
		        </div>
	        </div>
		...
		<div class="well outter_hpl col-sm-12" style="">
			<div class="col-sm-8" style="padding: 0 0;">
				...
				<div class="record_detail" style="">
					<dl>
<!-- 			          <dt class="record_font_detail" style=""><i class="fa fa-circle" style="color:#4b76b5;margin-right:5px;"></i>123456</dt> -->
			          <dt class="record_font_detail" style=""><i class="fa fa-circle" style="color:#4b76b5;margin-right:5px;font-size:20px;"></i>累計運動紀錄筆數共 ${hplMap['hpsp_times']} 次</dt>
			        </dl>
		        </div>
			</div>
	...
	<div class="well outter_button" style="">
		...
		<a class="btn btn-default col-sm-12" id="" href="<%=request.getContextPath()%>/hpl/HplServlet.do?action=past&requestURL=<%=request.getServletPath()%>" role="button" style="margin-bottom:20px;font-size:20px;color:#4b76b5;font-weight:bold;">
		 	返回
		</a>
	</div>
