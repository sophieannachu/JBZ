...
private static final Set<Session> allSessions = Collections.synchronizedSet(new HashSet<Session>());
	...
	@OnOpen
	public void onOpen(@PathParam("myName") String myName, @PathParam("sendMem") String sendMem, Session userSession) throws IOException {
		allSessions.add(userSession);
		String myName2 = new String(myName.getBytes("ISO-8859-1"),"utf-8");
		String sendMem2 = new String(sendMem.getBytes("ISO-8859-1"),"utf-8");
		System.out.println(myName);
		userSession.getUserProperties().put("sendMem", sendMem2);
		userSession.getUserProperties().put("myName", myName2);
		System.out.println("已連線至ROOM " + sendMem2);
		System.out.println(userSession.getId() + ": 已連線");
		System.out.println(myName2 + ": 已連線");
		System.out.println(sendMem2 + ": 房號");
//		userSession.getBasicRemote().sendText("WebSocket 連線成功");
	...
	public void onMessage(Session userSession, String message) {
		String sendMem = (String) userSession.getUserProperties().get("sendMem");
