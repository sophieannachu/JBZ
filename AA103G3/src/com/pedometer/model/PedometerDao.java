...
public class PedometerDao implements PedometerDao_interface{
	...
	public Integer getSumByMemno(Integer memno) {
		String sql = "SELECT sum(pedo_total) pedo_total FROM pedorec WHERE memno = ?";
		Connection conn = null;
		PreparedStatement ps = null;
		Integer pedo_total =null;
		try {
			conn = ds.getConnection();
			ps = conn.prepareStatement(sql);
			ps.setInt(1, memno);
	...
	@Override
	public Integer getSumPedo() {
		String sql = "SELECT sum(pedo_total) pedo_total FROM pedorec";
		Connection conn = null;
		PreparedStatement ps = null;
		Integer pedo_total =null;
		try {
